package demoj2code.web.rest;

import demoj2code.DemoJ2CodeApp;
import demoj2code.config.Constants;
import demoj2code.domain.Authority;
import demoj2code.domain.User;
import demoj2code.repository.AuthorityRepository;
import demoj2code.repository.UserRepository;
import demoj2code.security.AuthoritiesConstants;
import demoj2code.service.MailService;
import demoj2code.service.UserService;
import demoj2code.service.dto.PasswordChangeDTO;
import demoj2code.service.dto.UserDTO;
import demoj2code.web.rest.errors.ExceptionTranslator;
import demoj2code.web.rest.vm.KeyAndPasswordVM;
import demoj2code.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = DemoJ2CodeApp.class)
