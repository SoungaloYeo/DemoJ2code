package demoj2code.repository;

import demoj2code.DemoJ2CodeApp;
import demoj2code.config.Constants;
import demoj2code.config.audit.AuditEventConverter;
import demoj2code.domain.PersistentAuditEvent;
...
import static demoj2code.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
